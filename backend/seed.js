...
// Clear existing data
db.exec('DELETE FROM task_logs; DELETE FROM notifications; DELETE FROM tasks; DELETE FROM machines; DELETE FROM users; DELETE FROM sqlite_sequence;');
...
console.log('   Worker 2:   worker2@shopfloor.com    / Worker@123');
